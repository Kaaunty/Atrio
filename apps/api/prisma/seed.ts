...
async function main() {
  ...
  const workSchedule = await prisma.workSchedule.create({
    data: {
      ...
      scheduleRules: [
        { dayOfWeek: 0, isWorkDay: false, expectedWorkMinutes: 0, expectedMinutes: 0 },
        { dayOfWeek: 1, isWorkDay: true, startTime: '08:00', endTime: '17:00', lunchStart: '12:00', lunchEnd: '13:00', expectedWorkMinutes: 480, expectedMinutes: 480 },
        { dayOfWeek: 2, isWorkDay: true, startTime: '08:00', endTime: '17:00', lunchStart: '12:00', lunchEnd: '13:00', expectedWorkMinutes: 480, expectedMinutes: 480 },
        { dayOfWeek: 3, isWorkDay: true, startTime: '08:00', endTime: '17:00', lunchStart: '12:00', lunchEnd: '13:00', expectedWorkMinutes: 480, expectedMinutes: 480 },
        { dayOfWeek: 4, isWorkDay: true, startTime: '08:00', endTime: '17:00', lunchStart: '12:00', lunchEnd: '13:00', expectedWorkMinutes: 480, expectedMinutes: 480 },
        { dayOfWeek: 5, isWorkDay: true, startTime: '08:00', endTime: '16:00', lunchStart: '12:00', lunchEnd: '13:00', expectedWorkMinutes: 420, expectedMinutes: 420 },
        { dayOfWeek: 6, isWorkDay: false, expectedWorkMinutes: 0, expectedMinutes: 0 },
      ],
    },
  });
